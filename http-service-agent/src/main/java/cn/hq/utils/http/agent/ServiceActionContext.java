...
class ServiceActionContext {
	...
	public ServiceActionContext(Method serviceMethod, HttpMethod requestMethod, RequestPathTemplate pathTemplate,
			PathParamResolver pathParamResolver, RequestParamResolver requestParamResolver,
			RequestBodyResolver requestBodyResolver, ResponseConverter responseConverter, Class<?>[] thrownExceptionTypes,
